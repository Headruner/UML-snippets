...
| **Given**                                                                 | **When**                                                                                     | **Then**                                                                                     |
|---------------------------------------------------------------------------|----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| User opens the app and is directed to registration (no session).         | System loads an empty registration form with fields: Full Name, Email, Phone.                    | Form renders with validation rules (e.g., email format, phone length).                        |
